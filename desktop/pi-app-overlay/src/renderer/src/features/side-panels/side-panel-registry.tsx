...
import { InsarPipelineSidePanel } from './insar-pipeline-side-panel'
...
export const ADAPTER_PANEL_COMPONENTS: Record<string, ComponentType<SidePanelComponentProps>> = {
  'workspace-tasks': WorkspaceTasksSidePanel,
  'generic-json': GenericAdapterSidePanel,
  'insar-pipeline': InsarPipelineSidePanel,
}
...
export function renderSidePanel(item: {
  ...
  if (ADAPTER_PANEL_COMPONENTS[comp]) return ADAPTER_PANEL_COMPONENTS[comp]
